...
export type Deployment = { Mainnet: null } | { Local: null } | { Test: null } | { Testnet: null };
...
export type RequestedTx = { Burn: null } | { Lock: null } | { ApproveAndLock: null };
...
export type Task = { Evm: { chain: EvmChain; task: EvmTask } } | { Icp: IcpTask };
export type Token =
	| { BOB: null }
	| { ICP: null }
	| { GLDT: null }
...
export interface _SERVICE {
	...
	get_events: ActorMethod<[bigint, bigint], { Ok: Array<string> } | { Err: string }>;
	...
	get_forwarding_accounts: ActorMethod<[EvmChain, bigint, bigint], Array<ForwardingAccount>>;
	get_forwarding_address: ActorMethod<[IcpAccount], { Ok: string } | { Err: string }>;
	get_forwarding_status: ActorMethod<
		[ForwardEvmToIcpArg],
		{ Ok: ForwardingResponse } | { Err: string }
	>;
	get_forwarding_transactions: ActorMethod<[EvmChain], Array<SignedForwardingTx>>;
	...
	get_transfers: ActorMethod<[GetTransfersArg], { Ok: Array<Transfer> } | { Err: string }>;
